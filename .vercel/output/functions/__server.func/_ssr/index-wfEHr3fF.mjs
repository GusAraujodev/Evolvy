import { r as reactExports, V as jsxRuntimeExports } from "./server-BzyN_tUO.mjs";
...
const Dumbbell = createLucideIcon("dumbbell", __iconNode$j);
const __iconNode$i = [
  [
    "path",
    {
...
const Frown = createLucideIcon("frown", __iconNode$f);
const __iconNode$e = [
  [
    "path",
    {
...
const Shirt = createLucideIcon("shirt", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
...
function Splash({ onStart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-dvh bg-background overflow-hidden flex flex-col px-6 pt-20 pb-10", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-foreground flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-black text-lg", children: "E" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold tracking-tight", children: "Evolvy" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.h1,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-primary px-2 -mx-1 rounded-md inline-block", children: "Evoluir" }),
                  " é para todos."
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "Alcance sua melhor versão com um plano que se adapta à sua rotina."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function Onboarding({ onComplete, onBack }) {
  ...
  const progress2 = (index + 1) / total * 100;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background flex flex-col px-6 pt-12 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-muted-foreground tabular-nums", children: [
        index + 1,
        "/",
        total
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[1.75rem] font-extrabold tracking-tight leading-[1.15]", children: q.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-3", children: q.subtitle }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 mt-8", children: q.options.map((opt, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.button,
              {
                ...
                className: `group relative flex items-center gap-4 p-5 rounded-3xl border text-left transition-all active:scale-[0.98] ${selected ? "bg-primary border-primary shadow-glow" : "bg-card border-foreground/8 hover:border-foreground/20"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-12 h-12 rounded-2xl flex items-center justify-center transition-colors ${selected ? "bg-foreground/10" : "bg-background"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 font-semibold text-base text-foreground", children: opt.label })
                ]
              },
              opt.id
            );
...
function Auth({ onAuthenticated, onBack }) {
  ...
  const [forgot, setForgot] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const [shakeKey, setShakeKey] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background flex flex-col px-6 pt-12 pb-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mt-10",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold text-foreground bg-primary inline-block px-3 py-1 rounded-full uppercase tracking-wider", children: forgot ? "Recuperação" : mode === "signup" ? "Sua jornada está pronta" : "Bem-vindo de volta" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[2rem] font-extrabold tracking-tight leading-[1.1] mt-4", children: forgot ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Recupere o acesso",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "à sua evolução." })
          ] }) : mode === "signup" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Crie sua conta para",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "salvar seu progresso." })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Entre e continue",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "de onde parou." })
          ] }) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "flex-1 flex flex-col gap-6 mt-12", noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "text-[11px] font-bold text-muted-foreground uppercase tracking-wider", children: "E-mail" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-3 mt-2 px-4 h-14 rounded-2xl border bg-card transition-colors ${emailErr ? "border-destructive/60 bg-destructive/5" : "border-foreground/10 focus-within:border-foreground"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: `w-4 h-4 ${emailErr ? "text-destructive" : "text-muted-foreground"}` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "email",
            ...
            emailErr && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { role: "alert", className: "text-xs font-semibold text-destructive mt-2", children: emailErr })
          ]
        },
        `email-${shakeKey}-${emailErr ? "err" : "ok"}`
      ),
      !forgot && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 10 },
          animate: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "password", className: "text-[11px] font-bold text-muted-foreground uppercase tracking-wider", children: "Senha" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-3 mt-2 px-4 h-14 rounded-2xl border bg-card transition-colors ${passErr ? "border-destructive/60 bg-destructive/5" : "border-foreground/10 focus-within:border-foreground"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: `w-4 h-4 ${passErr ? "text-destructive" : "text-muted-foreground"}` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "password",
            ...
            passErr && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { role: "alert", className: "text-xs font-semibold text-destructive mt-2", children: passErr })
          ]
        },
        `pass-${shakeKey}-${passErr ? "err" : "ok"}`
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto space-y-4", children: [
        ...
        !forgot ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: mode === "signup" ? "Já tenho conta" : "Criar nova conta"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
function validateField(f, value) {
  ...
  if (f.type === "number") {
    ...
    if (f.min !== void 0 && n < f.min) return `Valor mínimo: ${f.min}.`;
    if (f.max !== void 0 && n > f.max) return `Valor máximo: ${f.max}.`;
  }
  return null;
}
function DataCapture({ initialName, onComplete, onBack }) {
  const [data, setData] = reactExports.useState({ name: initialName, age: "", weight: "", height: "" });
  ...
  const submit = () => {
    const next = {};
    fields.forEach((f) => {
      next[f.id] = validateField(f, data[f.id]);
    });
    setErrors(next);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background flex flex-col px-6 pt-12 pb-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mt-10",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary-foreground bg-foreground inline-block px-3 py-1 rounded-full", children: "Quase lá" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[1.9rem] font-extrabold tracking-tight leading-[1.15] mt-4", children: [
            "Agora, vamos aos detalhes",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "para personalizar seu treino e dieta." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col gap-5 mt-10", children: fields.map((f, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: f.id, className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: f.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-baseline gap-2 mt-1 border-b transition-colors ${err ? "border-destructive" : "border-foreground/15 focus-within:border-primary"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: f.id,
              ...
              f.suffix && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground", children: f.suffix })
            ] }),
...
function Plans({ onSelect, onSkip, onBack }) {
  const [selected, setSelected] = reactExports.useState("premium");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background flex flex-col px-6 pt-12 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, className: "mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[2rem] font-extrabold tracking-tight leading-[1.1]", children: [
        "Escolha o ritmo",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "da sua evolução."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-3", children: "Cancele quando quiser. Sem letras miúdas." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col gap-4 mt-8", children: plans.map((p, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          className: `relative text-left rounded-3xl p-6 border-2 transition-all active:scale-[0.99] ${isSelected ? "border-foreground bg-card shadow-soft" : "border-foreground/10 bg-card"}`,
          children: [
            p.recommended && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -top-3 right-5 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full flex items-center gap-1 shadow-glow", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3" }),
              " Recomendado"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: p.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-extrabold tracking-tight mt-1", children: [
                  p.price,
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-muted-foreground", children: "/mês" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-7 h-7 rounded-full border-2 flex items-center justify-center transition-all ${isSelected ? "bg-foreground border-foreground" : "border-foreground/20"}`,
                  children: isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-background" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium mt-3", children: p.tagline }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-4 space-y-2", children: p.benefits.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-foreground/80", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-foreground mt-0.5 shrink-0" }),
              b
            ] }, b)) })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "Continuar gratuitamente por enquanto"
        }
      )
    ] })
  ] });
}
function ProgressRing({ progress: progress2, size = 64, stroke = 6 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: size, height: size, className: "-rotate-90", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: size / 2, cy: size / 2, r: radius, strokeWidth: stroke, className: "stroke-muted", fill: "none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.circle,
        {
          cx: size / 2,
...
function WaterWidget({ ml, goalMl, onAdd, onRemove }) {
  const pct = Math.min(100, ml / goalMl * 100);
  const liters = (ml / 1e3).toFixed(2).replace(".", ",");
  const goalLiters = (goalMl / 1e3).toFixed(1).replace(".", ",");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-3xl p-5 shadow-soft", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-2xl bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplet, { className: "w-4 h-4 text-foreground", fill: "currentColor" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground", children: "Hidratação" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base font-bold text-foreground tabular-nums", children: [
            liters,
            "L ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-3 bg-background rounded-full overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-2", children: "+250ml por toque" })
  ] });
}
...
function HomeScreen({ name }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh pb-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-6 pt-14 pb-6 flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground capitalize", children: dateLabel }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-extrabold tracking-tight mt-1", children: [
          greeting,
          ",",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: name || "amigo" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressRing, { progress: progress2, size: 72 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          initial: { opacity: 0, y: 14 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold tracking-tight", children: "Treino do dia" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-muted-foreground" })
            ] }),
            isRestDay ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-card border border-foreground/8 p-6 shadow-soft", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-6 h-6 text-foreground mb-3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-extrabold tracking-tight leading-tight text-foreground", children: "O descanso faz parte da evolução." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2", children: "Seu corpo está se reconstruindo." })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold opacity-70 uppercase tracking-wider", children: "Push Day" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold mt-1 leading-tight", children: "Peito, ombro e tríceps" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-4 text-sm font-semibold", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-11 h-11 rounded-full flex items-center justify-center transition-colors ${workoutDone ? "bg-foreground text-primary" : "bg-foreground/10"}`, children: workoutDone ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold", children: "→" }) })
                ] })
              }
            )
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold tracking-tight mb-3", children: "Sua rotina" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: meals.map((m) => {
              const Icon2 = m.icon;
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-foreground" }) }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-9 h-9 rounded-full flex items-center justify-center border-2 transition-all ${done ? "bg-primary border-primary shadow-glow" : "border-foreground/15"}`,
                        children: done && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-primary-foreground" })
                      }
                    )
                  ]
                },
        ...
        motion.section,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-primary flex items-center justify-center shadow-glow shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-5 h-5 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-primary", children: "Suporte personalizado" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mt-1 leading-snug", children: "Dúvidas no treino ou dieta? Fale com nossos especialistas agora." })
                ] })
              ]
            }
          )
...
function BottomTabs({ active, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-50 px-4 pb-5 pt-2 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass border border-foreground/5 rounded-full px-2 py-2 mx-auto max-w-md flex items-center justify-around shadow-soft pointer-events-auto", children: tabs.map((t) => {
    const Icon2 = t.icon;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `flex flex-col items-center justify-center gap-0.5 px-4 py-2 rounded-full transition-all ${isActive ? "bg-primary text-primary-foreground shadow-glow" : "text-foreground/50"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold", children: t.label })
        ]
      },
      t.id
    );
...
function PlaceholderScreen({ title, subtitle, icon: Icon2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 12 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-extrabold tracking-tight", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: subtitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 rounded-3xl bg-card p-10 flex flex-col items-center text-center shadow-soft", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary flex items-center justify-center shadow-glow mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-8 h-8 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground", children: "Em breve" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1 max-w-xs", children: "Estamos preparando essa área com tudo que você precisa." })
        ] })
      ]
    }
  );
...
function Index() {
  ...
  if (stage === "splash") return /* @__PURE__ */ jsxRuntimeExports.jsx(Splash, { onStart: () => setStage("onboarding") });
  if (stage === "onboarding") return /* @__PURE__ */ jsxRuntimeExports.jsx(Onboarding, { onBack: () => setStage("splash"), onComplete: () => setStage("auth") });
  if (stage === "auth") return /* @__PURE__ */ jsxRuntimeExports.jsx(Auth, { onBack: () => setStage("onboarding"), onAuthenticated: () => setStage("data") });
  if (stage === "data") return /* @__PURE__ */ jsxRuntimeExports.jsx(DataCapture, { initialName: profile.name, onBack: () => setStage("auth"), onComplete: (d) => {
    const cleanData = {
      ...d,
  ...
  if (stage === "plans") return /* @__PURE__ */ jsxRuntimeExports.jsx(Plans, { onBack: void 0, onSelect: () => setStage("app"), onSkip: () => setStage("app") });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white min-h-dvh max-w-md mx-auto relative shadow-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      tab === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, { name: profile.name, waterAmount: water, onAddWater: addWater }),
      tab === "workouts" && /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderScreen, { title: "Treinos", subtitle: "Sua evolução física", icon: Dumbbell }),
      tab === "nutrition" && /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderScreen, { title: "Nutrição", subtitle: "Sua base de saúde", icon: Apple }),
      tab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderScreen, { title: "Perfil", subtitle: `Evoluindo sempre, ${profile.name}`, icon: User })
    ] }, tab) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://wa.me/5511999999999", target: "_blank", className: "fixed top-6 right-6 z-50 bg-white/80 backdrop-blur-md p-2 rounded-full border border-zinc-100 shadow-sm hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg", className: "w-5 h-5 opacity-80", alt: "Suporte" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomTabs, { active: tab, onChange: setTab })
  ] });
}
export {
  Index as component
