...
const appCss = "/assets/styles-DGSiYB0X.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Evolvy — Sua evolução diária" },
      { name: "description", content: "App de saúde minimalista para treinos, nutrição e hidratação." },
...
const $$splitComponentImporter = () => import("./index-wfEHr3fF.mjs");
